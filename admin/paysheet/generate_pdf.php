...
// Fetch paysheet details with employee and company info
$query = "SELECT p.*, e.employee_name, e.employee_nic, e.position, e.department, e.employee_email, e.employee_address,
          c.company_name, c.company_address, c.company_phone, c.company_email
          FROM paysheets p
...
<head>
    ...
    <title>Paysheet - <?php echo htmlspecialchars($paysheet['employee_name']); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
